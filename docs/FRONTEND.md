...
│   │   └── 2fa-setup/
│   │
│   └── (dashboard)/         # Rotas do dashboard (com layout)
...
│   ├── use-auth.ts         # Auth hooks (planned)
│   └── ...
│
...
// Fazer request (token é adicionado automaticamente)
...
- ✅ Cache automático (1 min stale time)
...
- [ ] Usar 'use client' se necessário
- [ ] Adicionar tipos adequados
- [ ] Implementar error boundaries (se crítico)
- [ ] Adicionar loading states
- [ ] Testar responsividade
- [ ] Adicionar testes (se crítico)
...
```typescript
// Já incluído no QueryProvider
// Acesse via botão flutuante no canto inferior
...
```typescript
// lib/api.ts
// Já configurado para logar erros
