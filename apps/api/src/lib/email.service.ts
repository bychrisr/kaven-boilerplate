...
class EmailService {
  ...
  async sendInviteEmail(
    ...
    const html = this.getInviteTemplate(email, inviteUrl, tenantName, inviterName);
...
<body style="margin: 0; padding: 0; font-family: Arial, sans-serif; background-color: #f4f4f4;">
   ...
   */
  private getInviteTemplate(email: string, inviteUrl: string, tenantName: string, inviterName: string): string {
    return `
<!DOCTYPE html>
<html>
<head>
  ...
  <table width="100%" cellpadding="0" cellspacing="0" style="background-color: #f4f4f4; padding: 20px;">
    <tr>
      <td align="center">
        <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 8px; overflow: hidden;">
          <tr>
            <td style="background: linear-gradient(135deg, #FF6B6B 0%, #556270 100%); padding: 40px 20px; text-align: center;">
              <h1 style="color: #ffffff; margin: 0; font-size: 28px;">Você recebeu um convite!</h1>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding: 40px 30px;">
              ...
              <p style="color: #333333; font-size: 16px; line-height: 1.6; margin: 0 0 20px 0;">
                <strong>${inviterName}</strong> convidou você para participar do workspace <strong>${tenantName}</strong> no Kaven.
              </p>
              ...
              <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  <td align="center" style="padding: 20px 0;">
                    <a href="${inviteUrl}" 
                       style="display: inline-block; background: linear-gradient(135deg, #FF6B6B 0%, #556270 100%); color: #ffffff; text-decoration: none; padding: 14px 40px; border-radius: 6px; font-size: 16px; font-weight: bold;">
                      Aceitar Convite
                    </a>
                  </td>
                </tr>
