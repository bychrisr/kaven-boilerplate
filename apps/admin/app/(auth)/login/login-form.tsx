  ...
  return (
    <div className="bg-[#212B36] rounded-2xl p-8 shadow-2xl border border-gray-700/50">
      <div className="mb-8">
        ...
        <h4 className="text-2xl font-bold text-white mb-2">Sign in to your account</h4>
        <p className="text-gray-400 text-sm">
          Don&apos;t have an account?{' '}
          <Link href="/register" className="text-primary-main hover:text-primary-light font-semibold transition-colors">
            Get started
          </Link>
        </p>
      </div>
