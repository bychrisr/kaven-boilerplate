  ...
  const faqs = [
    {
      ...
      answer: 'Navigate to Users > Create User, fill in the required information, and click Create User.'
    },
    {
    ...
    },
    {
      ...
      answer: 'There are three roles: Super Admin (full access), Tenant Admin (tenant-scoped access), and User (limited access).'
    },
    {
      question: 'How do I enable 2FA?',
      answer: 'Go to Settings > Security, click "Enable 2FA", scan the QR code with your authenticator app, and enter the verification code.'
    },
    {
      question: 'Can I export data?',
      answer: 'Yes, most tables have an export button that allows you to download data in CSV or PDF format.'
    }
  ];
