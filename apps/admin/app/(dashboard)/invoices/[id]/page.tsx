  ...
  if (error || !invoice) {
    return (
      <div className="flex h-96 flex-col items-center justify-center gap-4">
        ...
        <Link href="/invoices" className="text-primary-main hover:underline">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">
              Emitida em{' '}
              {format(new Date(invoice.createdAt), "d 'de' MMMM 'de' yyyy", { locale: ptBR })}
            </p>
          </div>
        </div>
          ...
          <div className="rounded-lg border bg-white p-6 shadow-sm">
            ...
            <div className="space-y-3">
              <div>
                ...
                <p className="text-sm text-gray-900 break-all">{invoice.subscriptionId || '-'}</p>
              </div>
            </div>
          </div>
        </div>
