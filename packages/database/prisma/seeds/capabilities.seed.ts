...
/**
 * Seed de Capabilities - Permissões Atômicas
 * 
...
export async function seedCapabilities() {
  ...
  const capabilities = [
    ...
    // ===========================
    {
      ...
      resource: 'servers',
      action: 'read',
      description: 'Visualizar informações de servidores',
      category: 'DevOps',
      sensitivity: CapabilitySensitivity.SENSITIVE,
      scope: CapabilityScope.GLOBAL,
    },
    {
      ...
      resource: 'servers',
      action: 'manage',
      description: 'Gerenciar configurações de servidores',
      category: 'DevOps',
    ...
    },
    {
      ...
      action: 'read',
      description: 'Visualizar histórico de deployments',
      category: 'DevOps',
      sensitivity: CapabilitySensitivity.NORMAL,
      scope: CapabilityScope.GLOBAL,
    },
    ...
    },
    {
      ...
      resource: 'monitoring',
      action: 'read',
      description: 'Visualizar métricas de monitoramento',
      category: 'DevOps',
      sensitivity: CapabilitySensitivity.NORMAL,
      scope: CapabilityScope.GLOBAL,
    },
    ...
    },
    {
      ...
      resource: 'database',
      action: 'read',
      description: 'Visualizar informações do banco de dados',
      category: 'DevOps',
      sensitivity: CapabilitySensitivity.HIGHLY_SENSITIVE,
      scope: CapabilityScope.GLOBAL,
      requiresMFA: true,
    ...
    },
    {
      ...
      resource: 'secrets',
      action: 'read',
      description: 'Visualizar secrets e variáveis de ambiente',
      category: 'DevOps',
      sensitivity: CapabilitySensitivity.CRITICAL,
      scope: CapabilityScope.GLOBAL,
      requiresMFA: true,
    },
    {
      ...
      resource: 'secrets',
      action: 'manage',
      description: 'Gerenciar secrets e variáveis de ambiente',
      category: 'DevOps',
      sensitivity: CapabilitySensitivity.CRITICAL,
      scope: CapabilityScope.GLOBAL,
      requiresMFA: true,
    ...
    },
    {
      ...
      resource: 'incidents',
      action: 'manage',
      description: 'Gerenciar incidentes de produção',
      category: 'DevOps',
      sensitivity: CapabilitySensitivity.SENSITIVE,
      scope: CapabilityScope.GLOBAL,
    },
    ...
    },
    {
      ...
      resource: 'users',
      action: 'update',
      description: 'Atualizar usuários existentes',
      category: 'Management',
      sensitivity: CapabilitySensitivity.SENSITIVE,
      scope: CapabilityScope.TENANT,
    },
    ...
    },
    {
      ...
      resource: 'roles',
      action: 'read',
      description: 'Visualizar roles e permissões',
      category: 'Management',
      sensitivity: CapabilitySensitivity.SENSITIVE,
      scope: CapabilityScope.SPACE,
    },
    ...
    },
    {
      ...
      resource: 'settings',
      action: 'read',
      description: 'Visualizar configurações da plataforma',
      category: 'Management',
      sensitivity: CapabilitySensitivity.SENSITIVE,
      scope: CapabilityScope.GLOBAL,
    },
    ...
    },
    {
      ...
      action: 'user',
      description: 'Impersonar outros usuários',
      category: 'Management',
      sensitivity: CapabilitySensitivity.CRITICAL,
      scope: CapabilityScope.GLOBAL,
      requiresMFA: true,
